...
<form action="<?php echo base_url(); ?>index.php/Main/registration" method = "post">
  <div class="container">
    <h1>Register</h1>
    ...
    <button type="submit" onclick="return validate()" class="registerbtn">Register</button>
  </div>
...
document.getElementById("signin").onclick = function () {
        location.href = "<?php echo base_url(); ?>index.php/Main/login";
 };   
    
</script>
<?php for ($value = 0; $value < $valid; $value++){?>
